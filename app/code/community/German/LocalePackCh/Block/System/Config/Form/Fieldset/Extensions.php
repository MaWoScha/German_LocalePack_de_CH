 ...
 */
class German_LocalePackCh_Block_System_Config_Form_Fieldset_Extensions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
		...
		$html .= "<p>".$helper->__("The installed language pack only provides translations of in Magento existing texts. If you want to prepare your Magento store on the legal requirements in %s or expand common payment methods, we recommend to install the following additional extensions.",
				$helper->__("Switzerland"))."</p>";
		$html .= "<hr style='margin-top:15px; margin-bottom:5px;' />";
		$html .= "<h3 style='margin-top:20px; margin-bottom:10xp;'>".$helper->__("Specific market adjustment for")." ".$helper->__("Swiss and European stores")."</h3>";
		$html .= "<dl>";
		...
		$html .= "<dt><b>Magento CH: Swiss Store</b> - <a href='https://github.com/integer-net/Magento-CH' target='_blank'>Configuration for Magento CE</a></dt>";
		$html .= "<dd>".$helper->__("Preconfigurated for the Swiss market")."</dd>";
		$html .= "<dt><b>nr-apps</b> - <a href='http://de.nr-apps.com/store/magento-ch.html' target='_blank'>Magento CH</a></dt>";
		$html .= "<dd>".$helper->__("Preconfigurated for the Swiss market")."</dd>";
		$html .= "</dl>";
